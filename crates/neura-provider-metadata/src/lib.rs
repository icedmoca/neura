...
pub const NEURA_LOGIN_PROVIDER: LoginProviderDescriptor = LoginProviderDescriptor {
    id: "neura",
    display_name: "Neura Subscription",
    auth_kind: LoginProviderAuthKind::ApiKey,
    auth_state_key: LoginProviderAuthStateKey::Neura,
    auth_status_method: "API key",
    aliases: &["subscription", "neura-subscription"],
    menu_detail: "curated neura subscription models",
    recommended: false,
    target: LoginProviderTarget::Neura,
