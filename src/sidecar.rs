...
const CLAUDE_CODE_KCODE_NOTICE: &str = "You are kcode, powered by Claude Code. You are a third-party CLI, not the official Claude Code CLI.";
...
mod tests {
    ...
    fn test_backend_selection_prefers_openai() {
        ...
        let temp = tempfile::TempDir::new().expect("create temp kcode home");
