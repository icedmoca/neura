...
impl NeuraProvider {
    ...
    fn apply_runtime_profile() {
        ...
        crate::env::set_var("NEURA_ACTIVE_PROVIDER", "openrouter");
...
impl Default for NeuraProvider {
    fn default() -> Self {
        Self::new()
    }
}
...
#[async_trait]
impl Provider for NeuraProvider {
    async fn complete(
        &self,
        messages: &[Message],
    ...
    fn uses_neura_compaction(&self) -> bool {
        self.inner.uses_neura_compaction()
    }
...
mod tests {
    ...
    #[test]
    fn neura_provider_enables_subscription_runtime_mode() {
        let _guard = crate::storage::lock_test_env();
        crate::subscription_catalog::clear_runtime_env();
        let runtime = tokio::runtime::Runtime::new().expect("tokio runtime");

        runtime.block_on(async {
            let provider = NeuraProvider::new();
    ...
    #[test]
    fn neura_provider_name_and_default_model_are_curated() {
        let _guard = crate::storage::lock_test_env();
        crate::subscription_catalog::clear_runtime_env();
        let runtime = tokio::runtime::Runtime::new().expect("tokio runtime");
