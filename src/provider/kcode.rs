...
impl KcodeProvider {
    ...
    fn apply_runtime_profile() {
        ...
        crate::env::set_var("KCODE_ACTIVE_PROVIDER", "openrouter");
...
impl Default for KcodeProvider {
    fn default() -> Self {
        Self::new()
    }
}
...
#[async_trait]
impl Provider for KcodeProvider {
    async fn complete(
        &self,
        messages: &[Message],
    ...
    fn uses_kcode_compaction(&self) -> bool {
        self.inner.uses_kcode_compaction()
    }
...
mod tests {
    ...
    #[test]
    fn kcode_provider_enables_subscription_runtime_mode() {
        let _guard = crate::storage::lock_test_env();
        crate::subscription_catalog::clear_runtime_env();
        let runtime = tokio::runtime::Runtime::new().expect("tokio runtime");

        runtime.block_on(async {
            let provider = KcodeProvider::new();
    ...
    #[test]
    fn kcode_provider_name_and_default_model_are_curated() {
        let _guard = crate::storage::lock_test_env();
        crate::subscription_catalog::clear_runtime_env();
        let runtime = tokio::runtime::Runtime::new().expect("tokio runtime");
