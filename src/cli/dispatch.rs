...
fn map_latent_subcommand(subcmd: LatentCommand) -> latent::LatentCommand {
    match subcmd {
        ...
        LatentCommand::FabricStatus => latent::LatentCommand::FabricStatus,
        LatentCommand::FabricEvents => latent::LatentCommand::FabricEvents,
        ...
        LatentCommand::LatentMemoryStatus => latent::LatentCommand::LatentMemoryStatus,
        LatentCommand::LatentMemoryBlocks => latent::LatentCommand::LatentMemoryBlocks,
